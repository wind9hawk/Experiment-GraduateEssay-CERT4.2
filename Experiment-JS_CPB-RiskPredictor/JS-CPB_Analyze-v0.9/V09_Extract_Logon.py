...
# DataSrc = r'G:\r5.2\logon.csv'
DataSrc = os.path.dirname(sys.path[0]) + '\\' + 'CERT4.2-logon.csv'
DataDst = os.path.dirname(sys.path[0]) + '\\' + r'CERT4.2_Logon_ByUsers_0.6'
if os.path.exists(DataDst) == False:
    os.mkdir(DataDst)
# 只根据第一个月数据建立用户个人的习惯上下班时间即可
# 该时间是用来计算Team的上下班时间的，而Team上下班时间才是用来衡量迟到早退的依据
Time_lst = ['2010-01']
