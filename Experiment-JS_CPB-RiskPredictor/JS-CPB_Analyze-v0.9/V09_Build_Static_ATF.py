# coding:utf-8
# 为了应用全局静态假设，我们需要重新合并CERT4.2用户中所有用户的最终ATF
# 从2011-04月份开始，初始化CERT5.2用户的ATF列表，并由后向前倒向回溯补充离职用户的ATF；

import os,sys
import copy

print '..<<建立CERT4.2全局静态ATF特征>>..\n'
Dst_Dir = sys.path[0]
...
Leave_Users = []
f_leave = open(Dst_Dir + '\\' + 'CERT4.2-Leave-Users_OnDay_0.9.csv', 'r')
